(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routes = [{ path: 'student', component: _student_student_component__WEBPACK_IMPORTED_MODULE_3__["StudentComponent"] }, { path: 'survey', component: _survey_survey_component__WEBPACK_IMPORTED_MODULE_4__["SurveyComponent"] }];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StudentComponent = /** @class */ (function () {
                function StudentComponent(http) {
                    this.http = http;
                    this.item = {};
                ...
                StudentComponent.prototype.onchange = function (value) {
                    this.item.university = value;
                    console.log(this.item.university);
                };
                StudentComponent.prototype.onCheckBoxchange = function (value, i, checked) {
                ...
                StudentComponent.prototype.onSelectchange = function (value) {
                ...
                StudentComponent.prototype.submit = function () {
                    ...
                    var obs = this.http.post('https://vizsm4p902.execute-api.us-east-1.amazonaws.com/prod/survey', object);
                    alert("Form has been submitted!");
                    this.form.reset;
                    obs.subscribe(function (response) { return _this.onSubmitAlert(); });
                };
                StudentComponent.prototype.onSubmitAlert = function () {
                    alert('Form Submitted !');
                };
                StudentComponent.prototype.onFormValid = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SurveyComponent = /** @class */ (function () {
                function SurveyComponent(http) {
                    this.http = http;
                }
                SurveyComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    //our get function using our REST API url.
                    var obs = this.http.get('https://vizsm4p902.execute-api.us-east-1.amazonaws.com/prod/survey');
                    obs.subscribe(function (response) {
                        _this.studentList = response.body;
